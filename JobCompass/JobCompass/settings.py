"""
Django settings for JobCompass project.
...
SECRET_KEY = 'django-insecure-w&v(-hdwlw%s$86(0d3s*xe+3rqta)-bj(+2j^mce9v2+kt0#*'
...
WSGI_APPLICATION = 'JobCompass.wsgi.application'
